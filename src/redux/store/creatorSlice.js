...
export const selectAllCreatorsStatus = (state) => state.creator.creatrosStatus;
export const selectAllCreatorsNextPage = (state) => state.creator.creators.next;
export const selectAllCreatorsPrevPage = (state) =>
