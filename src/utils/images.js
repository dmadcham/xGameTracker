...
// all images import and export
export { banner_image, sliderImages, join_image, game_details_image, loader, store_image, form_image, default_profile_image, dashboard_image };